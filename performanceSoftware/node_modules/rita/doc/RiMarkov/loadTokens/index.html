				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Loads an array of tokens (or words) into the model; <br/>each element in the array must be a single token for proper construction of the model. </td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>loadTokens(tokens);<br/>loadTokens(tokens, multiplier);</pre></td>
						</tr>
