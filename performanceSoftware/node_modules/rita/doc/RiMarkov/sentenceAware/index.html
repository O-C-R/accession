				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns whether the model will try to recognize (English-like) sentences in its input.<br><br>This value can only be set via the constructor</td>
						</tr>
