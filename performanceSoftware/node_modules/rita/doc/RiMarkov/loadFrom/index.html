				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Loads raw text into the object from one or more files/URLs</td>
						</tr>
						...
						<tr class="">
							...
							<!-- PLATFORM  -->
							<td>Delegates to RiTa.loadString() to load. To check if the object has finished loading, check RiMarkov.ready().</td>
						</tr>
