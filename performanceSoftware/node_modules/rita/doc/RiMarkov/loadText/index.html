				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						<tr class="name-row">
							...
							<!-- ClASS -->
							<td><h3><a href="../../RiMarkov.html">RiMarkov</a></h3></td>
						</tr>
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Loads a text string into the model after tokenizing it.</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>loadText(text);<br/>loadText(text, multiplier);<br/>loadText(text, multiplier, regex);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the string to load</td></tr><tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>weighting for text (optional, default=1) </td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>a regular expression to be used for tokenizing (optional, if not supplied, uses RiTa.tokenize())</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>RiMarkov</th><td width='75%'>this RiMarkov</td></tr>
							</table></td>
						</tr>
