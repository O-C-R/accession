				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Replaces the first instance of 'substitution' with 'replacement'. Regular expressions (non-global) will be used only if the 1st argument is a regular expression, otherwise only generic string-matching is used (special regex characaters are escaped)</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>replaceFirst(substitution, replacement);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String or Object (the regex pattern)</th><td width='75%'>the pattern</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the replacement</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>RiText</th><td width='75%'>this RiText</td></tr>
							</table></td>
						</tr>
