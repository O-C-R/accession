				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Starts a timer that calls 'onRiTaEvent()', or the specified callback (in JS), every 'period' seconds</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>RiText.timer(parent, period);<br/>RiText.timer(parent, period, callback);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>Object</th><td width='75%'>the parent object in which to find (optional in JS)</td></tr><tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>period (in seconds)</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String OR Function </th><td width='75%'>callback function to be called every 'period' seconds<br>the function name String (in Java) or the function itself (in JS) </td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>the unique id for the timer</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Note'>
							...
							<!-- NOTE  -->
							<td>The 'parent' object is optional in JS, and the optional callback is a function, rather than a String name</td>
						</tr>
