				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Computes a set of features for the RiText, including <a target=_new href='../../PhonemeTags.html'>phonemes</a>, syllables, stresses, etc. To access any of these, use myRiText.get(featureName)</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>rt.analyze(feature-type);</pre></td>
						</tr>
						...
						<tr class='Example'>
							...
							<div class="example">
								...
								<pre class="margin">myRiText.get("phonemes");<br>myRiText.get(RiTa.PHONEMES);<br>myRiText.get(RiTa.SYLLABLES);</pre>
							</div></td>
						</tr>
