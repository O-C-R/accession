				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Splits the object into an array of RiTexts, one per letter, maintaining the x and y position of each. Note: In most cases the original RiText should be disposed manually to avoid text a doubling effect (via RiText.dispose(originalRiText)).</td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>RiTexts[]</th><td width='75%'>RiTexts</td></tr>
							</table></td>
						</tr>
