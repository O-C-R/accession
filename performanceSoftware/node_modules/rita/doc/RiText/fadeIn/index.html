				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Fades in current text over <code>seconds</code> starting at <code>startTime</code>. <br/>Interpolates from the current color {r,g,b,a} to {r,g,b,255}.</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>rt.fadeIn(seconds, delay, callback);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>time in future to start (seconds)</td></tr><tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>time for fade (seconds)</td></tr><tr class=''><th width='25%' scope='row' class=nobold>function</th><td width='75%'>optional callback for when the action has completed (by default, uses onRiTaEvent(re))</td></tr>
							</table></td>
						</tr>
