				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Extracts the characters from this objects contained String, beginning at 'start' and continuing through the specified number of characters, and sets the current text to be that String. (from Javascript String)</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>rt.substr(start);<br/>rt.substr(start, length);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>The index where to start the extraction. First character is at index 0</td></tr><tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>(optional) The index where to stop the extraction. If omitted, it extracts the rest of the String</td></tr>
							</table></td>
						</tr>
