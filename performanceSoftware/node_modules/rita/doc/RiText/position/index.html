				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>rt.position();<br/>rt.position(x y);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>(optional) X coordinate</td></tr><tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>(optional) Y coordinate</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>RiText OR float[]</th><td width='75%'>either this RiText (for sets) or object {x, y} (for gets)</td></tr>
							</table></td>
						</tr>
