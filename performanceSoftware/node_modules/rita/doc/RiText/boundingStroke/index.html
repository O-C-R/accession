				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Set/gets the boundingStroke color for this RiText</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>rt.boundingStroke();<br/>rt.boundingStroke(r, b, a);<br/>rt.boundingStroke(rgbaArr);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>float OR float[]</th><td width='75%'>r</td></tr><tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>g</td></tr><tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>b</td></tr><tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>a</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>RiText OR float[]</th><td width='75%'>either this RiText (for sets) or the current color object (for gets)</td></tr>
							</table></td>
						</tr>
