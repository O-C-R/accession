				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>rt.startsWith(substr);</pre></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>boolean</th><td width='75%'>true if the character sequence represented by the argument is a prefix of the character sequence represented by this String; false otherwise. <br/>Note also that true will be returned if the argument is an empty String or is equal to this RiText object as determined by the equals() method.</td></tr>
							</table></td>
						</tr>
