				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Scales to 'theScale' over 'seconds' starting at 'delay' seconds in the future</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>rt.scaleTo(theScale)<br/>rt.scaleTo(theScale, seconds);<br/>rt.scaleTo(theScale, seconds, delay);<br/>rt.scaleTo(theScale, seconds, delay, callback);</pre></td>
						</tr>
