				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Sets/gets the scale factor for this RiText (takes 0-2 arguments) </td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>rt.scale();<br/>rt.scale(scaleX);<br/>rt.scale(scaleX, scaleY);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>the ScaleX ratio</td></tr><tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>(optional) the ScaleY ratio</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>RiText OR float[]</th><td width='75%'>either this RiText (for sets) or the current scales (for gets)</td></tr>
							</table></td>
						</tr>
