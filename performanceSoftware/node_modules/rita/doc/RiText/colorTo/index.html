				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Transitions to 'color' (rgba) over 'seconds' starting at 'delay' seconds in the future</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>rt.colorTo(colors)<br/>rt.colorTo(colorArr, seconds);<br/>rt.colorTo(colorArr, seconds, delay);<br/>rt.colorTo(colorArr, seconds, delay, callback);</pre></td>
						</tr>
