				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="name-row">
							...
							<!-- METHOD NAME -->
							<td><h3>RiText.randomColor</h3></td>
						</tr>
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns a random color in which the 3 values for rgb (or rgba if 'includeAlpha' is true), are between min and max </td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>RiText.randomColor(min, max, includeAlpha);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>number</th><td width='75%'>min value</td></tr><tr class=''><th width='25%' scope='row' class=nobold>number</th><td width='75%'>max value</td></tr><tr class=''><th width='25%' scope='row' class=nobold>boolean</th><td width='75%'>true if includes alpha</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>number[]</th><td width='75%'>random color vals, either [r,g,b] or [r,g,b,a]</td></tr>
							</table></td>
						</tr>
