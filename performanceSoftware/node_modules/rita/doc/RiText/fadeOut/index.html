				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Fades out current text over <code>seconds</code> starting at <code>startTime</code>. <br/>Interpolates from the current color {r,g,b,a} to {r,g,b,255}.</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>rt.fadeOut(seconds)<br/>fadeOut(seconds, delay);<br/>rt.fadeOut(seconds, delay, callback);<br/>rt.fadeOut(seconds, delay, callback, destroyOnComplete);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>time for fade (seconds)</td></tr><tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>(optional, default=0),  # of seconds in the future that the fade will start  (seconds)</td></tr><tr class=''><th width='25%' scope='row' class=nobold>function</th><td width='75%'>the callback to be invoked when the behavior has completed (optional: default=onRiTaEvent(e))</td></tr><tr class=''><th width='25%' scope='row' class=nobold>boolean</th><td width='75%'>(optional, default=false), destroys the object when the behavior completes</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>the unique id for this behavior</td></tr>
							</table></td>
						</tr>
