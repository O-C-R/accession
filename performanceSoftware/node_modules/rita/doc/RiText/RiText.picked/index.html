				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns all RiTexts that contain the point x,y or null if none do. <br/><br/>Note: this will return an array even if only one item is picked, therefore, you should generally use it as example</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>RiText.picked(x, y);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>x</td></tr><tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>y</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>RiText[]</th><td width='75%'>one or more RiTexts containing the point, or an empty array if none do.</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Example'>
							...
							<div class="example">
								...
								<pre class="margin">var rts = RiText.getPicked(mx, my);<br/>if (rts.length) { <br/>  rts[0].doSomething();<br/>}</pre>
							</div></td>
						</tr>
