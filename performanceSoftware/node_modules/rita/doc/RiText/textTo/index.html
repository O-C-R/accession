				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Fades out the current text and fades in the <code>newText</code> over <code>seconds</code></td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>rt.textTo(newText)<br/>rt.textTo(newText, seconds);<br/>rt.textTo(newText, seconds, startTime);<br/>textTo(newText, seconds, endAlpha, function callback);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>newText to be fade in</td></tr><tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>time for fade</td></tr><tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>(optional, default=255), the alpha to end on</td></tr><tr class=''><th width='25%' scope='row' class=nobold>function</th><td width='75%'>callback the callback to be invoked when the behavior has completed (optional: default=onRiTaEvent(e))</td></tr>
							</table></td>
						</tr>
