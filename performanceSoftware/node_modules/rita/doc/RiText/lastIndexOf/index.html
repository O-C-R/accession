				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>rt.lastIndexOf(searchstring);<br/>rt.lastIndexOf(searchstring, start);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String OR RiText</th><td width='75%'>searchstring (Required) or character to search for</td></tr><tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>(Optional) The start position in the String to start the search. If omitted, the search starts from position 0</td></tr>
							</table></td>
						</tr>
