				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="name-row">
							...
							<!-- METHOD NAME -->
							<td><h3>RiText.createLetters</h3></td>
						</tr>
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Creates an array of RiTexts, laid out in lines within the bounding rectange(x,y,w,h), one RiText per letter, with spacing determined by the specified font and leading</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>RiText.createLetters(pApplet, text, x, y, w, h, font, leading);</pre></td>
						</tr>
						...
						<tr class='Related'>
							...
							<!-- RELATED  -->
							<td>RiText.createLines(), RiText.createWords</td>
						</tr>
