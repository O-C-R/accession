				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="name-row">
							...
							<!-- METHOD NAME -->
							<td><h3>RiText.defaultFont</h3></td>
						</tr>
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Convenience method to set/get the default font</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>RiText.defaultFont();<br/>RiText.defaultFont(font);<br/>RiText.defaultFont(fontName, fontSize);</pre></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>null OR font</th><td width='75%'>either null (for 'sets') or the current default font (for 'gets')</td></tr>
							</table></td>
						</tr>
