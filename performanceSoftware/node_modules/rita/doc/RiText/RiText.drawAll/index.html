				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>A convenience method to draw all existing RiText objects (with no argument) or an array of RiText objects (if supplied as an argument)</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>RiText.drawAll();<br/>RiText.drawAll(riTextArray);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>RiText[]</th><td width='75%'>draws only the array if supplied (optional)</td></tr>
							</table></td>
						</tr>
