				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Replaces each occurrence of 'substitution' with 'replacement'. Regular expressions will be used if the 1st argument is a regular expression, otherwise only generic string-matching is used (special regex characaters are escaped)</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>replaceAll(substitution, replacement);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String or Object (the regex)</th><td width='75%'>the pattern to be matched</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the replacement string</td></tr>
							</table></td>
						</tr>
