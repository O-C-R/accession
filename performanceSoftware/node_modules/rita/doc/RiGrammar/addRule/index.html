				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>addRule(name, ruleStr, weight);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the rule name</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the rule definition</td></tr><tr class=''><th width='25%' scope='row' class=nobold>float</th><td width='75%'>the rule weight (optional, defaults to 1)</td></tr>
							</table></td>
						</tr>
