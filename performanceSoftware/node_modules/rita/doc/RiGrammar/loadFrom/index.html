				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						<tr class="name-row">
							...
							<!-- ClASS -->
							<td><h3><a href="../../RiGrammar.html">RiGrammar</a></h3></td>
						</tr>
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Re-initializes the grammar from a file or URL containing the grammar rules</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>loadFrom(url, option);</pre></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>RiGrammar</th><td width='75%'>this RiGrammar</td></tr>
							</table></td>
						</tr>
						...
						<tr class="">
							...
							<!-- PLATFORM  -->
							<td>Delegates to RiTa.loadString() to load. To check if the object has finished loading, check RiGrammar.ready(). Alternatively, one can use the &lt;script src=...&gt; tag to include the YAML/JSON grammar file in an html page (probably a better option).</td>
						</tr>
