				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Expands the grammar after replacing an instance of the non-terminal 'symbol' with the String in 'literal'.<br/>&nbsp;<br/>Guarantees that 'literal' will be in the final expanded String, assuming at least one instance of 'symbol' in the Grammar.</td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>a literal</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>a symbol</td></tr><tr class=''><th width='25%' scope='row' class=nobold>Object</th><td width='75%'>the object on which to call any (back-ticked) callback functions (optional)</td></tr>
							</table></td>
						</tr>
