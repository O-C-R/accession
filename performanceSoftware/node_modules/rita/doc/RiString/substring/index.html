				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Extracts the characters from a string, between two specified indices, and sets the current text to be that string. </td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>substring(from);<br/>substring(from, to);</pre></td>
						</tr>
