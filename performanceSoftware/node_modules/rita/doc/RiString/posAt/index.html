				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns the part-of-speech tag for the word at 'index' (from the <a href='../../PennTags.html'>PENN tag set</a>), using RiTa.tokenize() and RiTa.getPosTags()</td>
						</tr>
