				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						<tr class="name-row">
							...
							<!-- ClASS -->
							<td><h3><a href="../../RiTaEvent.html">RiTaEvent</a></h3></td>
						</tr>
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns true if the types match, else false e.g., RiTa.MOVE_TO</td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>the type</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>boolean</th><td width='75%'>true if the types match, else false</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Example'>
							...
							<div class="example">
								...
								<pre class="margin">if (event.isType(RiTa.MOVE_TO)) { ... } </pre>
							</div></td>
						</tr>
