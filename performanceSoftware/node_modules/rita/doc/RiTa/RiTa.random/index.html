				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Returns a random number between >= min (default=0) and < max (default=1)</td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>int or float</th><td width='75%'>min-value, (optional, default=0) </td></tr><tr class=''><th width='25%' scope='row' class=nobold>int or float</th><td width='75%'>max-value, (optional, default=1) </td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>int or float </th><td width='75%'>the random number (its type depends on input parameters)</td></tr>
							</table></td>
						</tr>
