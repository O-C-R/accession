				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Analyzes the input and returns a new string containing the stresses for each syllable of the input text </td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>RiTa.getStresses(word);<br/>RiTa.getStresses(wordArr);</pre></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>e.g., '01-0-1', with 1's meaning 'stressed', and 0's meaning 'unstressed', </td></tr>
							</table></td>
						</tr>
