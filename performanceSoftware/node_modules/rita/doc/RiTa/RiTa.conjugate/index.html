				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Conjugates the 'verb' according to the specified options</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>RiTa.conjugate(verb, args);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the verb stem</td></tr><tr class=''><th width='25%' scope='row' class=nobold>Object<br>(or Map in Java)</th><td width='75%'>args containing the relevant options for the conjugator</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the conjugated verb</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Example'>
							...
							<div class="example">
								...
								<pre class="margin">// Java<br><br>Map args = new HashMap();<br>args.put("tense", RiTa.PAST_TENSE);<br>args.put("number", RiTa.SINGULAR);<br>args.put("person", RiTa.FIRST_PERSON);<br><br>String c = RiTa.conjugate("swim", args);<br> <br> <br>// Javascript<br><br>var args = {<br>  tense: RiTa.PRESENT_TENSE,<br>  number: RiTa.SINGULAR,<br>  person: RiTa.THIRD_PERSON<br>};<br><br>var c = RiTa.conjugate('swim', args);<br> <br></pre>
							</div></td>
						</tr>
