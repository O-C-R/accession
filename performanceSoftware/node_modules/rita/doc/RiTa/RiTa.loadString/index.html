				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Loads the contents from one or more files/urls and then calls back to the supplied 'callback' function with the loaded string as an argument.</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>RiTa.loadString(url); RiTa.loadString(url, callback);<br/>RiTa.loadString(url, pApplet);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String or Array</th><td width='75%'>the filename(s) from which to load the file</td></tr><tr class=''><th width='25%' scope='row' class=nobold>Function (optional: the callback, for JavaScript only) or Object (optional: the PApplet, for Java only)</th><td width='75%'>If a Function (in JavaScript), it will be called after the file is loaded (with one string, the aggregate data, as its argument);<br>if no callback is supplied, or the argument is a PApplet(in Java), onRiTaEvent(re) will be called instead, with re.type() == RiTa.DATA_LOADED</td></tr>
							</table></td>
						</tr>
