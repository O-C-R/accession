				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Initializes the RiTa library for rendering visual output</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>RiTa.start(context);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>Object</th><td width='75%'>the current context, generally 'this'</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Note'>
							...
							<!-- NOTE  -->
							<td>Only required when using RiTa's Java renderer (RiText, etc), or loading external resources from with the Processing IDE</td>
						</tr>
						...
						<tr class='Example'>
							...
							<div class="example">
								...
								<pre class="margin">RiTa.start(this);</pre>
							</div></td>
						</tr>
						...
						<tr class="">
							...
							<!-- PLATFORM  -->
							<td>Java-only (has no effect in JS)</td>
						</tr>
