				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						<tr class="name-row">
							...
							<!-- ClASS -->
							<td><h3><a href="../../RiLexicon.html">RiLexicon</a></h3></td>
						</tr>
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Compares the characters of the input string  (using a version of the min-edit distance algorithm) to each word in the lexicon, returning the set of closest matches.</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>similarByLetter(word);<br/>similarByLetter(word, minAllowedDist);<br/>similarByLetter(word, minAllowedDist, preserveLength);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the word to match</td></tr><tr class=''><th width='25%' scope='row' class=nobold>int</th><td width='75%'>minimum edit distance for matches (optional, default=1)</td></tr><tr class=''><th width='25%' scope='row' class=nobold>boolean</th><td width='75%'>whether to return only words that match the length of the input word (optional, default=false)</td></tr>
							</table></td>
						</tr>
						...
						<tr class='Returns'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String[]</th><td width='75%'>the matching words</td></tr>
							</table></td>
						</tr>
