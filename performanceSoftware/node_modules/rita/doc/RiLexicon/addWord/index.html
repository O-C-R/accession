				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>Adds a word to the current lexicon. Note: will replace the word if it already exists</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>addWord(word, pronunciationData, posData);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>word</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>pronunciationData</td></tr><tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>posData</td></tr>
							</table></td>
						</tr>
