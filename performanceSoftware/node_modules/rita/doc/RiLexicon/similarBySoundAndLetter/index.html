				...
				<div class="span11">
					<table cellpadding="0" cellspacing="0" border="0" class="ref-item">
						...
						<tr class="name-row">
							...
							<!-- METHOD NAME -->
							<td><h3>similarBySoundAndLetter</h3></td>
						</tr>
						...
						<tr class="">
							...
							<!-- DESCRIPTION  -->
							<td>First calls similarBySound(), then filters the result set by the algorithm used in similarByLetter();<br/><br/>(useful when similarBySound() returns too large a result set)</td>
						</tr>
						...
						<tr class='Syntax'>
							...
							<!-- SYNTAX  -->
							<td><pre>similarBySoundAndLetter(word);</pre></td>
						</tr>
						...
						<tr class='Parameters'>
							...
							<table cellpadding="0" cellspacing="0" border="0" class="sub-table">
								<tr class=''><th width='25%' scope='row' class=nobold>String</th><td width='75%'>the word to match</td></tr>
							</table></td>
						</tr>
